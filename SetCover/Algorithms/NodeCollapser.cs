...
namespace SetCover
{
	...
	class NodeCollapser
	{
		public void RunAlgorithm(ref Dictionary<string, Node> protein, ref Dictionary<string, Node> pep, ref GlobalIDContainer globalIDTracker)
		{
			CollapseNodes(ref protein, ref pep, ref globalIDTracker);
		}
		...
		public void CollapseNodes(
			ref Dictionary<string, Node> proteins,
			ref Dictionary<string, Node> peptides,
			ref GlobalIDContainer globalIDTracker)
		{
			int count = 0;
